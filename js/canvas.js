const COLORS = ['248,255,246', '200,222,223', '179,215,222', '208,230,232'];
...
class Bubble {
  ...
  init() {
    ...
    this.alpha = generateDecimalBetween(1, 4) / 10;
    this.size = generateDecimalBetween(1, 10);
    this.translateX = generateDecimalBetween(0, this.canvasWidth);
    this.translateY = generateDecimalBetween(0, this.canvasHeight);
    this.velocity = generateDecimalBetween(10, 30);
...
const canvas = new CanvasBackground('bubbl-canvas');
canvas.start();
